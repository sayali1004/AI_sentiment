...
const QUAD = [
  { key: 'strengths',    label: 'Strengths',     icon: '▲', color: '#34d399', bg: 'rgba(52,211,153,0.07)',  border: 'rgba(52,211,153,0.25)',  glow: 'rgba(52,211,153,0.12)'  },
  { key: 'weaknesses',   label: 'Weaknesses',    icon: '▼', color: '#fb7185', bg: 'rgba(251,113,133,0.07)', border: 'rgba(251,113,133,0.25)', glow: 'rgba(251,113,133,0.12)' },
  { key: 'opportunities',label: 'Opportunities', icon: '◈', color: '#38bdf8', bg: 'rgba(56,189,248,0.07)',  border: 'rgba(56,189,248,0.25)',  glow: 'rgba(56,189,248,0.12)'  },
  { key: 'threats',      label: 'Threats',       icon: '⚠', color: '#fbbf24', bg: 'rgba(251,191,36,0.07)',  border: 'rgba(251,191,36,0.25)',  glow: 'rgba(251,191,36,0.12)'  },
]
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 8 }}>
      {QUAD.map(q => (
        <div key={q.key} style={{
          ...
          borderRadius: 14, padding: '22px 26px', boxShadow: `0 0 32px ${q.glow}`,
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
            <span style={{ color: q.color, fontSize: 18 }}>{q.icon}</span>
            <span style={{ color: q.color, fontFamily: 'Space Mono, monospace', fontSize: 13, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase' }}>
              {q.label}
            </span>
          </div>
